Game.Message = {
  ...
  setDisplayedMessage: function(dx){
    if(this.attr._messageNum + dx >= 0 && this.attr._messageNum + dx < 9 + this.attr._curMessages.length){
      this.attr._messageNum = this.attr._messageNum + dx;
    }
  }
